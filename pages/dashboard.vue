                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body border-none">
                        ...
                        <div class="w-100 text-center mb-4">
                            <button class="btn px-4 border-radius bg-light shadow text-primary mx-2 font-weight-bold">Cancel</button>
        ...
        <div class="row mt-4 position-relative">
            ...
            <div :class="showSideNav ? 's12 m4 l3' : 'd-none'" class="col bg-primary py-4 px-0 shadow position-relative" style="min-height: 700px;  max-height:100%">
                ...
                <div class="d-flex align-items-center mb-4 px-2">
                    <div>
                        <img class="bg-white" :src="profilePhoto" alt="">
                    </div>
                    <div class="px-2">
                        <h5 class="mb-0 text-white">John Michel</h5>
                        <p class="text-white mb-0 text-sm">John@gmail.com</p>
                    </div>
                </div>
                <div 
            ...
            <div class="col s12 m8 l9">                
                <dashboard-home class="animate__animated animate__zoomIn" @details="modal='VECHILE_RECORDS'" v-if="tab.value == 'DASHBOARD'" />
                <tollbooth class="animate__animated animate__zoomIn" v-else-if="tab.value == 'TOOL_BOOTH'" />
                <user class="animate__animated animate__zoomIn" v-else-if="tab.value == 'CREATE_USER'" />
                <manage-complaints class="animate__animated animate__zoomIn" v-else-if="tab.value == 'MANAGE_COMPLAINTS'" />
